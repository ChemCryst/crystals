...
@if "%CRDEBUG%" == "TRUE"     @set CDEF= /I%WXWIN%\include /I%WXLIB%\mswud  /I..\crashrpt /I..\python-headers-win\Include /D"Py_BUILD_CORE"  /D"WXUSINGDLL" /D"CRY_DEBUG"
@if not "%CRDEBUG%" == "TRUE" @set CDEF= /I%WXWIN%\include /I%WXLIB%\mswu /I..\crashrpt /I..\python-headers-win\Include /D"Py_BUILD_CORE" /D"WXUSINGDLL"
