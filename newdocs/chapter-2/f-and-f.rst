...
.. toodo::  (for my info only - todo list)
.. toodo::  see crystals/intro.rst#files
.. toodo::  see crystals/manual/readme.man
.. toodo::  see crystals/manual/primer.man
.. toodo::  see crystals/manual/guide.man#yfiles
.. toodo::  see crystals/manual/guide.man#yinitilisation
.. toodo::  see crystals/manual/crystals.man#yfiles
...
* Organising your Data:
  ...
  *My Documents* or on the desktop, and put the individual structural folders 
  into that.
  |br|\
  As well as files in each structure folder, CRYSTALS will create some sub-folders:
...
* Raw Data:
  ...
  |br|\
  See the section :ref:`LIST 6 <list6>` for more details.
  |br|\
  |br|\
  ...
  |br|\
  See the section :ref:`Introduction to COMMAND Mode <nket>` for and example.
  |br|\
  |br|\
...
* The *DSC* file:
  ...
  *something.dsc*. By default, the something is *crfilev2.dsc*. 
  ...
  |br|\
  See the section :ref:`Structure Database <crysdatabase>` for more details.
  |br|\
  |br|\
...
* The Output Files:
  ...
  * The listing file: The file *bfile.lis* is the principal plain text output from 
    ...
    text file *bfile#nn.lis* , where *nn* is a decimal number, incremented each time a 
    new file is started.
    |br|\
...
* Input Files:
  ...
  and *cif* and *fcf* files into LIST format. The generated files usually have the extension 
  *\*.cry*.
  |br|\
