...
Right Click Bond
^^^^^^^^^^^^^^^^
.. index:: Right Click Bond
.. index:: GUI Right Click Bond


.. image::  ../images/rc-bond-1.png

.. _bond:

The left hand image shows the symmetry operators associated with the disembodied oxygen 
atom.  The right hand image shows the options available by right clicking the 
double bond.
