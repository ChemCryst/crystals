...
some crystallographic experience, and for the moment it is necessary
...
Remember that all of the information pertaining to a structure analysis will be held in the 
binary database, *some-name.dsc*.
...
*Undo/Backup Model* on the Structure menu of the main tool bar. This shows details of all 
the stages of the development of your atomic model stored in the database. See 
:ref:`Recovering previous models <Recovering lists>` for brief details.
...
:ref:`Worked examples using The Guide can  be found in Chapter 1 <examples>` .
